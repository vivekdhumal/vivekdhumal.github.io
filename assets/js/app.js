...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component("medium-articles", __webpack_require__(162));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2), __webpack_require__(141).setImmediate))
...
Component.options.__file = "resources\\assets\\js\\components\\MediumArticles.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7fac4b09", Component.options)
  } else {
    hotAPI.reload("data-v-7fac4b09", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        formatedArticles: function formatedArticles() {
            return this.articles[0].map(function (article) {
                article.pubDate = __WEBPACK_IMPORTED_MODULE_0_moment___default()(article.pubDate).format("MMM DD, YYYY");
                return article;
            });
        }
    },
    mounted: function mounted() {
        ...
        this.loading = true;
        axios.get("https://api.rss2json.com/v1/api.json?rss_url=https://medium.com/feed/@vivekdhumal").then(function (data) {
            _this.loading = false;
            console.log(data.data.items);
            if (data.data.status == "ok") {
                console.log(data.data.status);
                _this.articles.push(data.data.items);
            }
  ...
  return _c(
    ...
    [
      _vm.loading
        ...
        : _vm._l(_vm.formatedArticles, function(article) {
            return _c("article", { staticClass: "mb-2 pt-4" }, [
              _c("h5", { staticClass: "text-md" }, [
                _c(
                  "a",
                  {
                    staticClass: "text-teal no-underline",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7fac4b09", module.exports)
  }
}
